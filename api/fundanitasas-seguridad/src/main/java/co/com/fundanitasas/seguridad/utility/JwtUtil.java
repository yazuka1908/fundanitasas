...
public class JwtUtil {
    ...
    private Key key; //  Codificación segura
    
    @Value("${seguridad.patron-expiracion}") 
    private Long patronExpiracion;
    ...
    public String generateToken(String username) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + (patronExpiracion)))
